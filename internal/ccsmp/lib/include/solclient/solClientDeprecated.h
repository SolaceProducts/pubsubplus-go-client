...
/*
 * The following session properties are still honoured but the deliver-to-one concept is an older
 * technology for implementing load-balancing.  Shared subscriptions should be used instead.
 */
...
/*
 * The following subCodes are no longer generated by the API
 */
  ...
  */
    ...
    */
	...
	#define SOLCLIENT_SESSION_CAPABILITY_SUPPORTS_XPE_SUBSCRIPTIONS     "SESSION_CAPABILITY_SUPPORTS_XPE_SUBSCRIPTIONS"    /**<  Boolean - The Session supports Xpath expression (XPE) subscriptions and routing based on subscription matches in XML content. */
        #define SOLCLIENT_SESSION_CAPABILITY_CUT_THROUGH                    "SESSION_CAPABILITY_CUT_THROUGH"      /**< Boolean - The peer supports the cut-through forwarding mode for Guaranteed message delivery. (Deprecated) */
	
	/* 
         * Deprecated constant used with solClient_subscribeFlags_t
         * SOLCLIENT_SUBSCRIBE_FLAGS_ISFILTER -  XML subscriptions are not supported.
         * SOLCLIENT_SUBSCRIBE_FLAGS_RX_ALL_DELIVER_TO_ONE - The deliver-to-one publisher flags refers to deprecated technology. Load-balancing is better achieved with shared subscriptions.
         */
